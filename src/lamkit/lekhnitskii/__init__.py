...
References
----------
.. [1] https://github.com/BenjaminETaylor/bjsfm/tree/master
.. [2] Esp, B. (2007). *Stress distribution and strength prediction of composite
...
.. [3] Lekhnitskii, S., Tsai, S., & Cheron, T. (1987). *Anisotropic plates* (2nd ed.).
   New York: Gordon and Breach science.
.. [4] Garbo, S. and Ogonowski, J. (1981) *Effect of variances and manufacturing
